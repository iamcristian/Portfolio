...
export const Footer = () => {
  ...
  const { end } = footer;
  return (
    <footer className="flex flex-col justify-center items-center px-5 sm:px-8 md:px-[8%] xl:px-[20%] gap-5 md:gap-10 h-full py-10 bg-white text-black dark:bg-black dark:text-white transition-colors duration-700">
